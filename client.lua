...
local puntoair = 0
local infojobs = {
	{x = 154.78, y = 169.64, z = 103.56},
    	{x = 180.73, y = 303.1, z = 103.89}, 
   	 {x = 171.37, y = 23.47, z = 72.22},
    	{x = 175.01, y = -66.89, z = 67.47}, 
   	 {x = 276.16, y = 3.94, z = 78.12}, 
    	{x = 133.97, y = 88.23, z = 81.53}, 
    	{x = 325.76, y = -180.6, z = 57.38}, 
	{x = -43.19, y = -65.5, z= 58.79}, 
	{x = 24.41, y= -241.56, z= 46.34}, 
	{x = 110.44, y= -290.51, z= 44.59}, -
